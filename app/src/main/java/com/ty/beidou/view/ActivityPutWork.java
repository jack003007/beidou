...
import com.ty.beidou.presenter.PutWorkPresenter;
...
public class ActivityPutWork extends BaseMvpActivity<IPutWorkView, PutWorkPresenter> implements IPutWorkView, LocationSource, AMapLocationListener, WeatherSearch.OnWeatherSearchListener {
...
//        presenter.getLayout();
    ...
    private HashMap<String, String> checkB4Post() {
        ...
        hash.put("companyid", MApplication.getInstance().getUser().getCompany_id());
        return hash;
    }
    ...
    @Override
    public PutWorkPresenter initPresenter() {
        return new PutWorkPresenter();
    }
