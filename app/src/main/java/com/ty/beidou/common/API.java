...
public class API {
     ...
     * 获取名称列表
     */
    public static String URL_GROUP = BASE + "index.php/Home/User/group";
     ...
     * 获取作业组长列表
     */
    public static String URL_PLAN_LEADER = BASE + "index.php/Home/Plan/leader";

    /**
     * 提交作业计划
     */
    public static String URL_PLAN_POST = BASE + "index.php/Home/Plan/post";
    /**
     * 统计 人员数量
     */
    public static String URL_CHART_PERSON = BASE + "index.php/Home/Chart/person";
}
