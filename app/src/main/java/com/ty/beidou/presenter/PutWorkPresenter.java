...
import com.ty.beidou.view.IPutWorkView;
...
public class PutWorkPresenter extends BasePresenter<IPutWorkView> {
    ...
    public void putWorkToServer(String json) {
        ...
        Logger.d(json);
        HttpSimpleRST.putJsonAutoAddToken(json, API.URL_WORK_POST, new Callback() {
            @Override
            public void onFailure(Call call, IOException e) {
                mHandler.post(new Runnable() {
                    @Override
